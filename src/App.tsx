...
const ROLE_ACCESS: Record<string, string[]> = {
  ...
  '/owner/attendance': ['SUPER_ADMIN', 'DEVELOPER'],
  '/manager': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/approvals/leave': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/approvals/overtime': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/approvals/correction': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/manager/edit-attendance': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/audit-log': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/print-qr': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/revisions': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/employees': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/payroll': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/analytics': ['MANAGER', 'COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings/holidays': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings/locations': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings/schedules': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings/overtime': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
  '/settings/payroll': ['COO', 'COMPANY_ADMIN', 'SUPER_ADMIN', 'DEVELOPER'],
};
